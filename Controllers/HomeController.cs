...
namespace SaferWatchWebApp.Models
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> GetData(string number)
        {
            ...
            CarrierLookup result = new CarrierLookup();
		...
		<RiskAssessment>
			...
			<Other>Acceptable</Other>
                ...
                XmlSerializer serializer = new XmlSerializer(typeof(CarrierLookup), "CarrierService32");
...

                {
                    try
                    {
                        ...
                        //{
                        //    Console.WriteLine(policyItem.companyName);
                        //}

                        //if (result.CarrierDetails.CertData?.Certificate?.Coverages != null)
                        //{
                        //    Console.WriteLine("\nCoverages:");
                        //    foreach (var coverage in result.CarrierDetails.CertData.Certificate.Coverages)
                        //    {
